...
public class Main {
	...
	// CREATION DES CARTES
		...
		communaute.addCarte(new CarteDeplacement("Allez en prison, ne passez pas par la case depart.", "goPrison", 9)); //Communaute : 12
		...
		chance.addCarte(new CarteDeplacement("Allez en prison, ne passez pas par la case depart.", "goPrison", 9)); 						//Chance : 1
		...
		partie.addCase(new Taxes(200));																						// Case 4
		...
		partie.addCase(new Compagnie("Compagnie de Distribution de l'electricite", "blanc", 150));							// Case 12
		...
		partie.addCase(new Parc());																							// Case 20
		...
		partie.addCase(new Terrain("Avevnue Henri-Martin", "rouge", 240, 20, 100, 300, 750, 925, 1100));					// Case 24
		...
		partie.addCase(new Compagnie("Compagnie de distribution des eaux", "blanc", 150));									// Case 28
		...
		partie.addCase(new Taxes(100));																						// Case 38
